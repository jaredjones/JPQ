...
//Don't change or HELL will break loose, this is the size of the file collison 32-bit seed
static const uint8_t JPQ_DEFAULT_FILE_COLLISION_SIZE_IN_BYTES           = 4;
...
static const uint16_t JPQ_DEFAULT_NUMBER_OF_CHARACTERS_PER_FOLDER       = 3000;         //Used to prevent giant JPQs before optimization
